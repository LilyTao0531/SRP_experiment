...
def solve_m2(inst_dir, sol_dir_model, inst_name, time_lim):
...
#         file.write('Hi there!, we are workin on'+ name_of_file)    
# =============================================================================
    def get_dist(p1, p2):
        dist2 = (p1[0]-p2[0])**2 +(p1[1]-p2[1])**2 
        dist = math.ceil(np.sqrt(dist2))
    ...
    # with io.open(instanceName,"r") as instance:
#     print(instanceName)
